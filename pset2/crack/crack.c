...
* of the password is less than or equal to 4 characters.
***************************************************************************/
...
// symbolic constants
#define MAX_PASSPHRASE_LENGTH 4
...
int main(int argc, char* argv[])
{
    ...
    matched = false;
    brute_force(passphrase, 0, MAX_PASSPHRASE_LENGTH, 32, 127);
...
* first and last char determine ASCII range of printable characters.
*/
void brute_force(char* phrase, size_t index, size_t length, char first, char last)
{
    if(matched == true)
